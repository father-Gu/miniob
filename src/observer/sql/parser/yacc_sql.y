...
%union {
  ...
  // added for insert
  RawTuple *                                 raw_tuple;
  vector<RawTuple> *                         raw_tuple_list;
  // added for join-tables
...
// added for insert
%destructor { delete $$; } <raw_tuple>
%destructor { delete $$; } <raw_tuple_list>
// added for join-tables
...
create_index_stmt:    /*create index 语句的语法解析树*/
    CREATE opt_unique INDEX ID ON ID LBRACE ID RBRACE
    {
      ...
      create_index.is_unique = $2;      /* $2 来自 opt_unique */
...
insert_stmt:        /*insert   语句的语法解析树*/
    ...
    //}
    //;
    INSERT INTO ID VALUES raw_tuple_list
    {
      $$ = new ParsedSqlNode(SCF_INSERT);
      $$->insertion.relation_name = $3;
...
raw_tuple_list:
    ...
    | raw_tuple_list COMMA raw_tuple {
      $$ = $1;
      $$->emplace_back(*$3);
      delete $3;
    }
